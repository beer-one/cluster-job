...
import (
	...
	"github.com/beer-one/cluster-job/internal/controller"
...
func init() {
	...
	utilruntime.Must(clusterbatchv1alpha.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0a8f3572.beer1.com",
	...
	if err := (&controller.ClusterJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ClusterJob")
		os.Exit(1)
	}
